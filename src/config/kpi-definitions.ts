...
const executiveKpis: KpiDefinition[] = [
  {
    ...
    description: "Number of newly eligible users in the cohort period (approved, non-prepaid, non-fee, card unblocked, account status G/N, DPD >= 0).",
    target: undefined,
    higherIsBetter: true,
  },
  {
    ...
    section: "executive",
    queryFn: "getEligibleAndTransactors",
    description: "Number of newly eligible users who made at least one authorized transaction within 7 days of first becoming eligible.",
    higherIsBetter: true,
  },
  {
    ...
    section: "executive",
    queryFn: "getEligibleAndTransactors",
    description: "Cohort-based: % of newly first-time eligible users who transacted within 7 days of becoming eligible (excludes prepaid and fee-only accounts)",
    target: 60,
    warningThreshold: 50,
    dangerThreshold: 40,
    higherIsBetter: true,
