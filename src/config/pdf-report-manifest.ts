...
export const REPORT_MANIFEST: ReportDef[] = [
  ...
  // 19. QRIS Experiment
  {
    ...
    metrics: [
      { labelKey: "pdf.metrics.testCohortSize", dataPath: "summary.test_size", unit: "count" },
      { labelKey: "pdf.metrics.controlCohortSize", dataPath: "summary.control_size", unit: "count" },
      { labelKey: "pdf.metrics.spendActiveRate", dataPath: "summary.test_sar", unit: "percent" },
      { labelKey: "pdf.metrics.totalSpend", dataPath: "summary.test_total_spend_idr", unit: "currency" },
      { labelKey: "pdf.metrics.totalTransactions", dataPath: "summary.test_total_transactions", unit: "count" },
    ],
    charts: [
      {
        id: "qris-cohort",
      ...
      {
        id: "qris-top-merchants",
        titleKey: "pdf.charts.topQrisMerchants",
        type: "table",
        dataKey: "topQrisMerchants",
        xAxisKey: "merchant_name",
        valueType: "currency",
      },
      {
        id: "qris-revenue-breakdown",
        titleKey: "pdf.charts.revenueBreakdown",
        type: "bar",
        dataKey: "revenueBreakdown",
        xAxisKey: "category",
        lines: [
          { dataKey: "test_revenue_idr", labelKey: "pdf.metrics.testRevenue", color: BRAND_COLORS.primary },
          { dataKey: "control_revenue_idr", labelKey: "pdf.metrics.controlRevenue", color: BRAND_COLORS.gray },
        ],
        valueType: "currency",
      },
      {
      ...
      {
        id: "qris-revenue-trajectory",
        titleKey: "pdf.charts.revenueTrajectory",
        type: "line",
        dataKey: "revenueTrajectory",
        xAxisKey: "week",
        lines: [
          { dataKey: "test_revenue_idr", labelKey: "pdf.metrics.testRevenue", color: BRAND_COLORS.primary },
          { dataKey: "control_revenue_idr", labelKey: "pdf.metrics.controlRevenue", color: BRAND_COLORS.gray },
      ...
      {
        id: "qris-incrementality",
        titleKey: "pdf.charts.incrementalityAnalysis",
        type: "table",
        dataKey: "incrementalityAnalysis",
        xAxisKey: "metric",
        valueType: "number",
      },
      {
        id: "qris-repayment",
        titleKey: "pdf.charts.repaymentBehavior",
        type: "table",
        dataKey: "repaymentBehavior",
        xAxisKey: "grp",
        valueType: "number",
      },
      {
        id: "qris-merchant-criteria",
        titleKey: "pdf.charts.qrisMerchantCriteria",
        type: "table",
        dataKey: "qrisMerchantCriteria",
        xAxisKey: "criterion",
        valueType: "number",
      },
      {
